    ...
    return <div id="goldenModal" className="golden-overlay" style={{ display: 'none' }} role="dialog" aria-modal="true" aria-labelledby="goldenTitle" aria-describedby="goldenSubtitle">
        <section className="golden-card">
            ...
            <div className="golden-body">
                ...
                <section id="goldenLibrary">
                    <div className="golden-section-heading"><div><h3>Biblioteca compartida <span id="goldenCount" className="golden-count">0</span></h3>
                        <p id="goldenLibrarySummary">Disponibles en este repositorio</p></div>
                        <button id="btnRebuildGolden" type="button" className="btn btn-dark">↻ Actualizar lista</button></div>
                ...
                <div id="goldenReview" style={{ display: 'none' }}>
                    ...
                    <section className="golden-review-section">
                        ...
                        <div className="golden-review-fields">
                            <label>Resultado en dispositivo<select id="goldenExecution" className="field-select"><option value="not-run">Todavía no ejecutado</option><option value="passed">Ejecutado correctamente</option><option value="failed">La ejecución falló</option></select><small>Este resultado lo declara el QA.</small></label>
                ...
                <section id="goldenSaved" className="golden-empty golden-saved" style={{ display: 'none' }}>
                    <span className="golden-saved-icon" aria-hidden="true">✓</span><h3>Versión guardada</h3><p>Puedes seguir trabajando en el caso y guardar una nueva versión después de la revisión del PR.</p>
            ...
            <footer id="goldenFooter" className="golden-footer">
                <p id="goldenLibraryHint">Para añadir un caso, abre su revisión y elige «Revisar y guardar golden».</p>
