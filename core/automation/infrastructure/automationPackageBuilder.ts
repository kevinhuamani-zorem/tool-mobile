...
function instructions(result: ResolverResult): string {
    ...
    return `# Contrato del agente de automatización\n\n` +
        ...
        `- En deterministic solo escribe query-requests.json o gap-resolutions.json. No edites agent-response.json ni archivos inmutables. Resuelve wording \"template\" en gherkinResolutions. Incluye testDesignReview y contrasta objetivo/aceptación con el efecto comprobado; la existencia de un control no demuestra su efecto. No incluyas roast: la presentación opcional se genera en otra sesión.\n` +
