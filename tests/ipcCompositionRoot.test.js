...
test('los 60 canales IPC existentes se reparten sin duplicarse entre las familias', () => {
    const seen = new Map();
    let total = 0;
    for (const family of HANDLER_FAMILIES) {
    ...
    const expectedByFamily = {
        ...
        automationHandlers: [
            'preview-framework-recovery', 'save-framework-recovery',
            ...
            'select-golden-repository', 'get-automation-memory-stats', 'get-automation-model-usage', 'save-golden-case', 'preview-golden-case', 'list-golden-cases', 'rebuild-golden-index', 'revoke-golden-case',
        ],
        generationHandlers: [
