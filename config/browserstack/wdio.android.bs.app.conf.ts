...
export const config: WebdriverIO.Config = {
    ...
    beforeScenario: async function (scenario) {
        ...
        if (!app_yape_package) {
            throw new Error('Missing APP_YAPE_PACKAGE environment variable');
        }
        ...
        try {
            await driver.activateApp(app_yape_package);
    ...
    capabilities: [
        {
            ...
            'appium:app': process.env.URL_BS_APK,
            'appium:deviceName': process.env.DEVICE_NAME || 'Xiaomi Redmi Note 11',
